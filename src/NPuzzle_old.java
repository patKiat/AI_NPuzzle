...
public class NPuzzle {
    ...
    public static double[] sum_h1 = new double[100];
    public static int[] num_h1 = new int[100];
    public static double[] sum_h2 = new double[100];
    public static int[] num_h2 = new int[100];
...
//            System.out.println("Expand\n"+currentBoard.getState().toString());
            ...
            //numSteps++;
            if(!isGoal(currentBoard.getState(), goalState))
            {
...
//                        System.out.println(pn.getAction());
    ...
    public static void main(String[] args) {
        NPuzzleState.studentID = 5988068;
